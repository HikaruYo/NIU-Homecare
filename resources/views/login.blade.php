...
<main class="flex h-screen">
    ...
    <div class="flex flex-col w-full justify-center items-center">
        <div class="flex flex-col w-3/4 p-4 bg-mainColor items-center rounded-xl space-y-8">
            ...
            <div class="">
                <form method="POST" action="/login" class="flex flex-col mb-4 space-y-2">
                    @csrf
                    {{-- Email Field --}}
                    ...
                    <div class="flex justify-center mt-2">
                        <p class="text-sm">Tidak punya akun? <a href="/register" class="text-blue-800 hover:text-blue-700">Buat Akun</a></p>
                    </div>
                </form>
            </div>
        </div>
