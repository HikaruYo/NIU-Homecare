    ...
    <div>
        ...
        <nav class="px-4 space-y-2">
            ...
            <a href="{{ route('dashboard.profil') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-md font-medium transition-all duration-300 group {{ $currentTab === 'profil' ? $activeClass : $inactiveClass }}">
            ...
            <a href="{{ route('dashboard.histori') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-md font-medium transition-all duration-300 group {{ $currentTab === 'histori' ? $activeClass : $inactiveClass }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
