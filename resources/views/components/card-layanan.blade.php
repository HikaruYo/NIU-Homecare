<div id="carousel-content" class="flex gap-4 w-max pb-4">
    {{-- TODO: buat agar carousel hanya muncul jika ada lebih dari 6 layanan --}}
    {{-- TODO: jika tidak ada layanan maka disable carousel dan tampilkan teks layanan kosong --}}
    @foreach($layanans as $layanan)
        <div
            ...
            data-carousel-item
        >
            <div class="absolute bottom-0 inset-x-0 p-2 bg-gradient-to-t from-black/60 to-transparent transform transition-transform duration-300 ease-out">
