<div id="carousel-content" class="flex gap-4 w-max pb-4">
    @foreach($layanans as $layanan)
        <div
            ...
            data-carousel-item
        >
            <div class="absolute bottom-0 inset-x-0 p-2 bg-gradient-to-t from-black/60 to-transparent transform translate-y-14 group-hover:translate-y-0 transition-transform duration-300 ease-out">
