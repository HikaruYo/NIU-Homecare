<div class="flex flex-col md:gap-10 gap-4 md:px-28 px-8 md:pt-28 pt-2 top-0">

    <div class="flex text-center gap-3 w-fit md:px-8 px-6 py-1 md:text-base text-sm rounded-full bg-linear-to-br from-mainColor to-thirdColor">
